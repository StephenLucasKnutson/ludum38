    ...
    return {
        ...
        execute: function() {
            ...
            World = (function () {
                ...
                World.prototype.createWellDistributedStartingPositions = function (numberOfPlayers) {
                    ...
                    var sorted = _(listOfPossibilities).sortBy(function (playerAssignment) {
                        var minimumDistance = Infinity;
                        for (var _i = 0, playerAssignment_1 = playerAssignment; _i < playerAssignment_1.length; _i++) {
                            var a = playerAssignment_1[_i];
                            for (var _a = 0, playerAssignment_2 = playerAssignment; _a < playerAssignment_2.length; _a++) {
                                var b = playerAssignment_2[_a];
        ...
        execute: function() {
            ...
            Simulator = (function () {
                function Simulator(autowired) {
                    this.players = [];
                    this.autowired = autowired;
                    var startingPositions = this.autowired.world.createWellDistributedStartingPositions(5);
                    for (var i = 0; i < 5; i++) {
