...
export class TileType {
    ...
    static initialize() {
        ...
        TileType.megalopolis = new TileType(
            ...
            0x000000,
            10000000 * TileType.defaultRevenuePerCost * 0.1,
            0.5,
            TileType.defaultChanceToLeave,
            0.05,
            10000000,
        ...
        TileType.city = new TileType(
            ...
            new ImageCity(),
            0x000000,
            5000000 * TileType.defaultRevenuePerCost * 0.1,
            0.5,
            TileType.defaultChanceToLeave,
            0.01,
            5000000,
        ...
        TileType.town = new TileType(
            ...
            new ImageTown(),
            0x000000,
            1000000 * TileType.defaultRevenuePerCost * 0.1,
            0.5,
            TileType.defaultChanceToLeave,
            0.005,
            1000000,
        ...
        TileType.village = new TileType(
            ...
            new ImageVillage(),
            0x000000,
            50000 * TileType.defaultRevenuePerCost * 0.1,
            0.5,
            TileType.defaultChanceToLeave,
            0.001,
            50000,
